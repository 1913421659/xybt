...
strVarCity += "                          <div class=\"data-result\"><em>多选： <strong><\/strong><\/em><\/div>";
...
function selectProvince(type, con, isremove) {
    ...
    if (type == "all") {
        ...
        strVarCity += "                              <p class=\"data-title\"><\/p>";
        strVarCity += "                              <div class=\"data-list data-list-hot\">";
        strVarCity += "                                <ul class=\"clearfix\">";
        for (var i in datahotcityxz) {
            strVarCity += '<li><a href=\"javascript:;\" data-code=\"' + datahotcityxz[i] + '\" data-name=\"' + dataarrary[datahotcityxz[i]][0] + '\" class=\"d-item hotA\"  onclick="selectProvince(\'sub\',this,'+datahotcityxz[i]+')">' + dataarrary[datahotcityxz[i]][0] + '<label>0</label></a></li>';
        }
        strVarCity += "                                <\/ul>";
        strVarCity += "                              <\/div>";
        strVarCity += "                              <p class=\"data-title\">全部省份<\/p>";
        strVarCity += "                              <div class=\"data-list  data_aaa\">";
        strVarCity += "                                <ul class=\"clearfix\">";
        for (var i in dataCityxz) {
            strVarCity += '<li><a href=\"javascript:;\" data-code=\"' + dataCityxz[i] + '\" data-name=\"' + dataarrary[dataCityxz[i]][0] + '\" class=\"d-item singleA\"  onclick="selectProvince(\'sub\',this,\'\')">' + dataarrary[dataCityxz[i]][0] + '<label>0</label></a></li>';
        }
        strVarCity += "                                <\/ul>";
        strVarCity += "                              <\/div>";
        ...
        $('.data-result span').each(function(index) {
            if ($('a[data-code=' + $(this).data("code") + ']').length > 0) {
                ...
                var numlabel = $('a[data-code=' + $(this).data("code").toString().substring(0, 100) + ']').find('label').text();
                $('a[data-code=' + $(this).data("code").toString().substring(0, 1000) + ']').find('label').text(parseInt(numlabel) + 1).show();
            }
        });
    }
    //显示下一级
...
//   $(".data-list-hot ul li a").click(function(){
//   	$(".data-list-hot ul li a").css({"cursor":"auto"});
//     	$(".data_aaa ul li a").css({ 'color': '#ccc', 'cursor': 'no-drop'});       
//     })
        
}
 $("body").on("click",".hotA",function(){
        // debugger
        if($(this).hasClass("d-item-active")){
            $(".data-list-hot ul li a").css({"cursor":"auto"});
            $(".data_aaa ul li a").addClass("disabled");
        }else{
            $(".data_aaa ul li a").removeClass("disabled");
        }
